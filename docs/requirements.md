...
id | CQ description | Existing/new terms | Rationale | Profile[^1] | Issue # |
 ...
 CQ11 | What are the intermediate inputs and outputs of the workflow steps (I care about the intermediate results) | [object](http://schema.org/object) and [result](http://schema.org/result) on the workflow run action or [CreateAction](https://schema.org/CreateAction) (?) | In cases when I am not able to reproduce the execution of a workflow, documentation of intermediate results can help me to reproduce it step by step.  | 1,2,3 | ?? |
